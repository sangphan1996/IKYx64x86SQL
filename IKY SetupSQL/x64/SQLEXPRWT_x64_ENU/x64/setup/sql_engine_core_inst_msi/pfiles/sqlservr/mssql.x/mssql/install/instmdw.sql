...
PRINT ''
PRINT '----------------------------------'
PRINT 'Starting execution of INSTMDW.SQL '
PRINT '----------------------------------'
GO
...
PRINT ''
PRINT 'Taking database to single user mode'
...
BEGIN
    PRINT 'Disabling asynchronous auto statistics while database in single user mode ...'
...
SET @new_value = '10.50.1600.1'     -- This will be replaced at build time with the sql build number
...
BEGIN
    ...
    IF (@old_value_char <> '10.50.1600.1')   -- value only used during development
    BEGIN
        ...
        BEGIN
            ...
            PRINT ''
            PRINT 'Restoring database to multi user mode before aborting the script'
            DECLARE @dbname sysname
...
BEGIN
    PRINT 'Creating table [core].[supported_collector_types_internal]...'
...
BEGIN
    PRINT 'Dropping view [core].[supported_collector_types]...'
    DROP VIEW core.supported_collector_types
END
GO

PRINT 'Creating view [core].[supported_collector_types]...'
GO
...
BEGIN
    PRINT 'Creating table [core].[source_info_internal]...'
...
BEGIN
    PRINT 'Creating table [core].[snapshot_timetable_internal]...'
...
BEGIN
    PRINT 'Creating table [core].[snapshots_internal]...'
...
BEGIN
    PRINT 'Dropping view [core].[snapshots]...'
    DROP VIEW core.snapshots
END
GO

PRINT 'Creating view [core].[snapshots]...'
GO
...
BEGIN
    PRINT 'Dropping procedure [core].[sp_create_snapshot] ...'
    DROP PROCEDURE [core].[sp_create_snapshot]
END
GO 

PRINT 'Creating procedure [core].[sp_create_snapshot] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [core].[sp_update_data_source] ...'
    DROP PROCEDURE [core].[sp_update_data_source]
END
GO 

PRINT 'Creating procedure [core].[sp_update_data_source] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [core].[sp_add_collector_type] ...'
    DROP PROCEDURE [core].[sp_add_collector_type]
END
GO 

PRINT 'Creating procedure [core].[sp_add_collector_type] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [core].[sp_remove_collector_type] ...'
    DROP PROCEDURE [core].[sp_remove_collector_type]
END
GO 

PRINT 'Creating procedure [core].[sp_remove_collector_type] ...'
GO
...
BEGIN
    PRINT 'Creating table [core].[purge_info_internal]...'
...
BEGIN
    PRINT 'Dropping procedure [core].[sp_purge_data] ...'
    DROP PROCEDURE [core].[sp_purge_data]
END
GO 

PRINT 'Creating procedure [core].[sp_purge_data] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [core].[sp_stop_purge] ...'
    DROP PROCEDURE [core].[sp_stop_purge]
END
GO 

PRINT 'Creating procedure [core].[sp_stop_purge] ...'
GO
...
BEGIN
    PRINT 'Creating function [core].[fn_check_operator] ...'
    DECLARE @sql nvarchar(max)
    SET @sql = 
...
BEGIN
    ...
    PRINT 'Dropping table [core].[wait_types] ...'
    DROP TABLE [core].[wait_types]
END

IF (NOT OBJECT_ID(N'core.wait_categories', 'U') IS NULL)
BEGIN
    PRINT 'Dropping table [core].[wait_categories] ...'
    DROP TABLE [core].[wait_categories]
END

PRINT 'Creating table [core].[wait_categories] ...'
...
--
--
PRINT 'Creating table [core].[wait_types] ...'
...
BEGIN
    PRINT 'Dropping view [core].[wait_types_categorized] ...'
    DROP VIEW [core].[wait_types_categorized];
END;
GO

PRINT 'Creating view [core].[wait_types_categorized] ...'
GO
...
BEGIN
    PRINT 'Dropping function [core].[fn_query_text_from_handle] ...'
    DROP FUNCTION [core].[fn_query_text_from_handle]
END
GO 

PRINT 'Creating function [core].[fn_query_text_from_handle] ...'
GO
...
BEGIN
    -- Must drop wait_types first since it references wait_categories via FK
    PRINT 'Dropping table [core].[performance_counter_report_group_items] ...'
    DROP TABLE [core].[performance_counter_report_group_items]
END
GO

PRINT 'Creating table [core].[performance_counter_report_group_items] ...'
...
BEGIN
    PRINT 'Creating table [snapshots].[performance_counter_instances]...'
...
BEGIN
    PRINT 'Creating table [snapshots].[performance_counter_values]...'
...
BEGIN
    PRINT 'Dropping view [snapshots].[performance_counters]...'
    DROP VIEW [snapshots].[performance_counters]
END

PRINT 'Creating view [snapshots].[performance_counters]...'
GO
...
BEGIN
    PRINT 'Dropping function [snapshots].[fn_get_performance_counters] ...'
    DROP FUNCTION [snapshots].[fn_get_performance_counters]
END
GO 

PRINT 'Creating function [snapshots].[fn_get_performance_counters] ...'
GO
...
BEGIN
    PRINT 'Dropping function [snapshots].[fn_get_performance_counter_statistics] ...'
    DROP FUNCTION [snapshots].[fn_get_performance_counter_statistics]
END
GO 

PRINT 'Creating function [snapshots].[fn_get_performance_counter_statistics] ...'
GO
...
BEGIN
    PRINT 'Creating table [snapshots].[trace_info]...'
...
BEGIN
    PRINT 'Creating table [snapshots].[trace_data]...'
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[sp_trace_get_info] ...'
    DROP PROCEDURE [snapshots].[sp_trace_get_info]
END
GO 

PRINT 'Creating procedure [snapshots].[sp_trace_get_info] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[sp_trace_update_info] ...'
    DROP PROCEDURE [snapshots].[sp_trace_update_info]
END
GO 

PRINT 'Creating procedure [snapshots].[sp_trace_update_info] ...'
GO
...
BEGIN
    PRINT 'Dropping function [snapshots].[fn_trace_gettable] ...'
    DROP FUNCTION [snapshots].[fn_trace_gettable]
END
GO 

PRINT 'Creating function [snapshots].[fn_trace_gettable] ...'
GO
...
BEGIN
    PRINT 'Creating table [snapshots].[notable_query_text]...'
...
BEGIN
    PRINT 'Creating table [snapshots].[notable_query_plan]...'
...
BEGIN
    PRINT 'Creating table [snapshots].[distinct_queries]...'
...
BEGIN
    PRINT 'Creating table [snapshots].[distinct_query_to_handle]...'
...
BEGIN
    PRINT 'Dropping function [snapshots].[fn_get_query_text] ...'
    DROP FUNCTION [snapshots].[fn_get_query_text]
END
GO 

PRINT 'Creating function [snapshots].[fn_get_query_text] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[sp_get_unknown_query_text] ...'
    DROP PROCEDURE [snapshots].[sp_get_unknown_query_text]
END
GO 

PRINT 'Creating procedure [snapshots].[sp_get_unknown_query_text] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[sp_get_unknown_query_plan] ...'
    DROP PROCEDURE [snapshots].[sp_get_unknown_query_plan]
END
GO 

PRINT 'Creating procedure [snapshots].[sp_get_unknown_query_plan] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[sp_update_query_text] ...'
    DROP PROCEDURE [snapshots].[sp_update_query_text]
END
GO 

PRINT 'Creating procedure [snapshots].[sp_update_query_text] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[sp_update_query_plan] ...'
    DROP PROCEDURE [snapshots].[sp_update_query_plan]
END
GO 

PRINT 'Creating procedure [snapshots].[sp_update_query_plan] ...'
GO
...
BEGIN
    PRINT 'Creating table [snapshots].[os_wait_stats]...'
...
BEGIN
    PRINT 'Creating table [snapshots].[os_latch_stats]...'
...
BEGIN
    PRINT 'Creating table [snapshots].[active_sessions_and_requests]...'
...
BEGIN
    PRINT 'Creating table [snapshots].[os_schedulers]...'
...
BEGIN
    PRINT 'Creating table [snapshots].[os_memory_nodes]...'
...
BEGIN
    PRINT 'Creating table [snapshots].[os_process_memory]...'
...
BEGIN
    PRINT 'Creating table [snapshots].[sql_process_and_system_memory]...';
...
BEGIN
    PRINT 'Creating table [snapshots].[os_memory_clerks]...'
...
BEGIN
    PRINT 'Creating table [snapshots].[query_stats]...'
...
BEGIN
    PRINT 'Dropping view [snapshots].[distinct_query_stats]...'
    DROP VIEW [snapshots].[distinct_query_stats]
END
GO

PRINT 'Creating view [snapshots].[distinct_query_stats]...'
GO
...
BEGIN
    PRINT 'Creating table [snapshots].[disk_usage]...'
...
BEGIN
    PRINT 'Creating table [snapshots].[log_usage]...'
...
BEGIN
    PRINT 'Creating table [snapshots].[io_virtual_file_stats]...'
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_snapshot_times] ...'
    DROP PROCEDURE [snapshots].[rpt_snapshot_times]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_snapshot_times] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_interval_collection_times] ...'
    DROP PROCEDURE [snapshots].[rpt_interval_collection_times]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_interval_collection_times] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_next_and_previous_collection_times] ...'
    DROP PROCEDURE [snapshots].[rpt_next_and_previous_collection_times]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_next_and_previous_collection_times] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_generic_perfmon] ...'
    DROP PROCEDURE [snapshots].[rpt_generic_perfmon]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_generic_perfmon] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_generic_perfmon_pivot] ...'
    DROP PROCEDURE [snapshots].[rpt_generic_perfmon_pivot]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_generic_perfmon_pivot] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_wait_stats] ...'
    DROP PROCEDURE [snapshots].[rpt_wait_stats]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_wait_stats] ...'
GO
...
BEGIN
    PRINT 'Dropping function [snapshots].[fn_hexstrtovarbin] ...'
    DROP FUNCTION [snapshots].[fn_hexstrtovarbin]
END
GO 

PRINT 'Creating function [snapshots].[fn_hexstrtovarbin] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_top_query_stats] ...'
    DROP PROCEDURE [snapshots].[rpt_top_query_stats]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_top_query_stats] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_query_stats] ...'
    DROP PROCEDURE [snapshots].[rpt_query_stats]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_query_stats] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_query_plan_stats] ...'
    DROP PROCEDURE [snapshots].[rpt_query_plan_stats]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_query_plan_stats] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_query_plan_stats_timeline] ...'
    DROP PROCEDURE [snapshots].[rpt_query_plan_stats_timeline]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_query_plan_stats_timeline] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_query_plan_missing_indexes] ...'
    DROP PROCEDURE [snapshots].[rpt_query_plan_missing_indexes]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_query_plan_missing_indexes] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_query_plan_parameters] ...'
    DROP PROCEDURE [snapshots].rpt_query_plan_parameters
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_query_plan_parameters] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_query_plan_details] ...'
    DROP PROCEDURE [snapshots].rpt_query_plan_details
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_query_plan_details] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_blocking_chains] ...'
    DROP PROCEDURE [snapshots].[rpt_blocking_chains]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_blocking_chains] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_blocking_chain_detail] ...'
    DROP PROCEDURE [snapshots].[rpt_blocking_chain_detail]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_blocking_chain_detail] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_active_sessions_and_requests] ...'
    DROP PROCEDURE [snapshots].[rpt_active_sessions_and_requests]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_active_sessions_and_requests] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_sql_memory_clerks] ...'
    DROP PROCEDURE [snapshots].[rpt_sql_memory_clerks]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_sql_memory_clerks] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_sql_process_and_system_memory] ...'
    DROP PROCEDURE [snapshots].[rpt_sql_process_and_system_memory]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_sql_process_and_system_memory] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_sampled_waits] ...'
    DROP PROCEDURE [snapshots].[rpt_sampled_waits]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_sampled_waits] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_sampled_waits_longest] ...'
    DROP PROCEDURE [snapshots].[rpt_sampled_waits_longest]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_sampled_waits_longest] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_sampled_waits_hottest_resources] ...'
    DROP PROCEDURE [snapshots].[rpt_sampled_waits_hottest_resources]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_sampled_waits_hottest_resources] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_io_virtual_file_stats] ...'
    DROP PROCEDURE [snapshots].[rpt_io_virtual_file_stats]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_io_virtual_file_stats] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_list_all_servers] ...'
    DROP PROCEDURE [snapshots].[rpt_list_all_servers]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_list_all_servers] ...'
GO
...
/**********************************************************************/
PRINT ''
PRINT 'Create schema custom_snpshots...'
GO
...
/**********************************************************************/
PRINT ''
PRINT 'Granting permissions to MDW security roles...'
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_waiting_sessions] ...'
    DROP PROCEDURE [snapshots].[rpt_waiting_sessions]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_waiting_sessions] ...'
GO
...
BEGIN
    PRINT 'Dropping function [snapshots].[fn_get_notable_query_plans] ...'
    DROP FUNCTION [snapshots].[fn_get_notable_query_plans]
END

PRINT 'Creating function [snapshots].[fn_get_notable_query_plans]'
Go
...
BEGIN
    PRINT 'Dropping function [snapshots].[fn_get_notable_query_text] ...'
    DROP FUNCTION [snapshots].[fn_get_notable_query_text]
END

PRINT 'Creating function [snapshots].[fn_get_notable_query_text]'
Go
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_sql_memory_counters_one_snapshot] ...'
    DROP PROCEDURE [snapshots].[rpt_sql_memory_counters_one_snapshot]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_sql_memory_counters_one_snapshot] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_sql_memory_clerks_one_snapshot] ...'
    DROP PROCEDURE [snapshots].[rpt_sql_memory_clerks_one_snapshot]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_sql_memory_clerks_one_snapshot] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_sql_process_memory_one_snapshot] ...'
    DROP PROCEDURE [snapshots].[rpt_sql_process_memory_one_snapshot]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_sql_process_memory_one_snapshot] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_memory_counters_one_snapshot] ...'
    DROP PROCEDURE [snapshots].[rpt_memory_counters_one_snapshot]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_memory_counters_one_snapshot] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_memory_rates_one_snapshot] ...'
    DROP PROCEDURE [snapshots].[rpt_memory_rates_one_snapshot]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_memory_rates_one_snapshot] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_cpu_counters_one_snapshot] ...'
    DROP PROCEDURE [snapshots].[rpt_cpu_counters_one_snapshot]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_cpu_counters_one_snapshot] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_cpu_queues_one_snapshot] ...'
    DROP PROCEDURE [snapshots].[rpt_cpu_queues_one_snapshot]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_cpu_queues_one_snapshot] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_cpu_usage_per_process] ...'
    DROP PROCEDURE [snapshots].[rpt_cpu_usage_per_process]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_cpu_usage_per_process] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_sessions_and_connections] ...'
    DROP PROCEDURE [snapshots].[rpt_sessions_and_connections]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_sessions_and_connections] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_requests_and_compilations] ...'
    DROP PROCEDURE [snapshots].[rpt_requests_and_compilations]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_requests_and_compilations] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_plan_cache_hit_ratio] ...'
    DROP PROCEDURE [snapshots].[rpt_plan_cache_hit_ratio]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_plan_cache_hit_ratio] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_tempdb] ...'
    DROP PROCEDURE [snapshots].[rpt_tempdb]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_tempdb] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_disk_speed_one_snapshot] ...'
    DROP PROCEDURE [snapshots].[rpt_disk_speed_one_snapshot]
END
GO

PRINT 'Creating procedure [snapshots].[rpt_disk_speed_one_snapshot] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_disk_queues_one_snapshot] ...'
    DROP PROCEDURE [snapshots].[rpt_disk_queues_one_snapshot]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_disk_queues_one_snapshot] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_disk_ratios_one_snapshot] ...'
    DROP PROCEDURE [snapshots].[rpt_disk_ratios_one_snapshot]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_disk_ratios_one_snapshot] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_disk_usage_per_process] ...'
    DROP PROCEDURE [snapshots].[rpt_disk_usage_per_process]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_disk_usage_per_process] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_waiting_sessions_per_snapshot] ...'
    DROP PROCEDURE [snapshots].[rpt_waiting_sessions_per_snapshot]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_waiting_sessions_per_snapshot] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_memory_usage_per_process] ...'
    DROP PROCEDURE [snapshots].[rpt_memory_usage_per_process]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_memory_usage_per_process] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_wait_stats_by_category_by_snapshot] ...'
    DROP PROCEDURE [snapshots].[rpt_wait_stats_by_category_by_snapshot]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_wait_stats_by_category_by_snapshot] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_cpu_usage] ...'
    DROP PROCEDURE [snapshots].[rpt_cpu_usage]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_cpu_usage] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_mem_usage] ...'
    DROP PROCEDURE [snapshots].[rpt_mem_usage]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_mem_usage] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_io_usage] ...'
    DROP PROCEDURE [snapshots].[rpt_io_usage]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_io_usage] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_network_usage] ...'
    DROP PROCEDURE [snapshots].[rpt_network_usage]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_network_usage] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_wait_stats_one_snapshot] ...'
    DROP PROCEDURE [snapshots].[rpt_wait_stats_one_snapshot]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_wait_stats_one_snapshot] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_server_activity] ...'
    DROP PROCEDURE [snapshots].[rpt_server_activity]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_server_activity] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_wait_stats_one_snapshot_one_category] ...'
    DROP PROCEDURE [snapshots].[rpt_wait_stats_one_snapshot_one_category]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_wait_stats_one_snapshot_one_category] ...'
GO
...
BEGIN
    PRINT 'Dropping procedure [snapshots].[rpt_sql_process_memory] ...'
    DROP PROCEDURE [snapshots].[rpt_sql_process_memory]
END
GO 

PRINT 'Creating procedure [snapshots].[rpt_sql_process_memory] ...'
GO
...
BEGIN
    PRINT 'Dropping database trigger [add_operator_check] ...'
    DROP TRIGGER [add_operator_check] ON DATABASE
END
GO 

PRINT 'Creating database trigger [add_operator_check] ...'
GO
...
BEGIN
    PRINT 'Dropping database trigger [deny_drop_table] ...'
    DROP TRIGGER [deny_drop_table] ON DATABASE
END
GO 

PRINT 'Creating database trigger [deny_drop_table] ...'
GO
...
BEGIN
    ...
    IF (@growth_percent > 0 AND @max_size_kb > @file_size_kb)
    BEGIN
      ...
      DECLARE @row_count INT;
        ...
        DECLARE @processing_time_current DATETIMEOFFSET(7) = SYSDATETIMEOFFSET();
         ...
         INSERT INTO [sysutility_ucp_core].[volumes_internal] (
                ...
                total_space_available, free_space,
                batch_time, processing_time)
...
-- Put the database back into multi user mode
PRINT ''
PRINT 'Restoring database to multi user mode'
DECLARE @dbname sysname
SET @dbname = QUOTENAME(DB_NAME())
...
BEGIN
    PRINT ''
    PRINT 'Re-enabling asynchronous auto statistics ...'
...
PRINT ''
PRINT '----------------------------------'
PRINT 'Execution of INSTMDW.SQL complete'
PRINT '----------------------------------'
GO
